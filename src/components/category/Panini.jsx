...
const Panini = () => {
  ...
  return (
    <div className="pt-[80px]" id="panini">
     <h2 className="mb-5 text-[28px] font-bold sm:mb-4 sm:text-[24px] md:mb-4 md:text-[24px]">🫔Panini</h2>
     <div className="grid grid-cols-4 gap-4 sm:grid-cols-2 md:grid-cols-3">
        {foods
          .filter((food) => food.category === "panini")
          .map((food) => (
            <div
